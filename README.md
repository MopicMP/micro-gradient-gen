...
> Micro css gradient generator and collection

[![npm version](https://badge.fury.io/js/micro-gradient-gen.svg)](https://www.npmjs.com/package/micro-gradient-gen)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install micro-gradient-gen
```

## Quick Start

```javascript
const { gen } = require('micro-gradient-gen');
...
```javascript
const { gen, batch } = require('micro-gradient-gen');
